...
struct sensor_power_setting hi843_power_setting_v3[] = {
    //SCAM AVDD 2.80V
    {
        .seq_type = SENSOR_AVDD,
        .data = (void*)"slave-sensor-avdd",
...
static sensor_t s_hi843_v3 =
{
    .intf = { .vtbl = &s_hi843_vtbl, },
    .power_setting_array = {
            .size = ARRAY_SIZE(hi843_power_setting_v3),
            .power_setting = hi843_power_setting_v3,
     },
};
...
{
    {
        .compatible = "huawei,hi843_cmb",
        .data = &s_hi843.intf,
    },
    {
        .compatible = "huawei,hi843_cmb_v3",
        .data = &s_hi843_v3.intf,
    },
    {
