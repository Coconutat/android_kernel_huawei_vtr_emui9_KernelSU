...
static struct sensor_power_setting imx219_stf_power_setting[] = {
...
static sensor_t s_imx219_stf =
{
    .intf = { .vtbl = &s_imx219_vtbl, },
    .power_setting_array = {
            .size = ARRAY_SIZE(imx219_stf_power_setting),
            .power_setting = imx219_stf_power_setting,
     },
};
...
{
    {
        .compatible = "huawei,imx219_stf",
        .data = &s_imx219_stf.intf,
    },
    {
...
static int imx219_config(hwsensor_intf_t* si, void  *argp)
{
    ...
    cam_debug("imx219 stf cfgtype = %d",data->cfgtype);
    switch(data->cfgtype) {
...
static int __init imx219_stf_init_module(void)
{
...
static void __exit imx219_stf_exit_module(void)
{
    if (NULL != s_intf) {
...
module_init(imx219_stf_init_module);
module_exit(imx219_stf_exit_module);
MODULE_DESCRIPTION("imx219_stf");
