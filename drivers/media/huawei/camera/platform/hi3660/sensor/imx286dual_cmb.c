...
static struct sensor_power_setting imx286dual_power_setting[] = {
    ...
    //M1 AVDD1  2.80V  [GPIO 020 Enable]
    {
    ...
    // DVDD 1.1v[LDO 20] ref KNT
    {
        .seq_type = SENSOR_DVDD,
        .config_val = LDO_VOLTAGE_V1P1V,  // 1.1v
        .sensor_index = SENSOR_INDEX_INVALID,
        .delay = 0,
    },
...
static struct sensor_power_setting imx286dual_power_setting_v3[] = {
...
static sensor_t s_imx286dual_v3 =
{
    .intf = { .vtbl = &s_imx286dual_vtbl, },//common intf
    .power_setting_array = {
        .size = ARRAY_SIZE(imx286dual_power_setting_v3),
        .power_setting = imx286dual_power_setting_v3,
     },
};
...
{
    {
        .compatible = "huawei,imx286dual_cmb",
        .data = &s_imx286dual.intf,
    },
    {
        .compatible = "huawei,imx286dual_cmb_v3",
        .data = &s_imx286dual_v3.intf,
    },
    { } /* terminate list */
};
