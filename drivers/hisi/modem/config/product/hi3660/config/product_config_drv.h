...
#define PRODUCT_FULL_VERSION_STR "Chicago V100R001C30B323SPC006" 
#endif 

#ifndef PRODUCT_DLOAD_SOFTWARE_VER
#define PRODUCT_DLOAD_SOFTWARE_VER "21C30B323S006C000" 
#endif 
...
#define PLATFORM_HISI_BALONG hi3660 
#endif 

#ifndef OS_LINUX_PRODUCT_NAME
#define OS_LINUX_PRODUCT_NAME hisi_3660_defconfig 
#endif 
...
#ifndef CONFIG_NOC_MID
#define CONFIG_NOC_MID 
#endif 
...
#ifndef CONFIG_BALONG_OCBC
#define CONFIG_BALONG_OCBC 
#endif 
...
#else
#ifndef MCORE_TEXT_START_ADDR
#define MCORE_TEXT_START_ADDR 0x80400000 
#endif 
...
#endif
#ifndef DDR_MEM_SIZE
#define DDR_MEM_SIZE 0x0A800000 
#endif 

#ifndef DDR_SECMEM_SIZE
#define DDR_SECMEM_SIZE 0x09200000 
#endif 
...
#ifndef DDR_GU_ADDR
#define DDR_GU_ADDR (/*lint -save -e778 -e835*/((DDR_APP_ACP_ADDR) + (DDR_APP_ACP_SIZE))/*lint -restore */ ) 
#endif 
...
#define DDR_ZSP_UP_ADDR (/*lint -save -e778 -e835*/((DDR_NV_ADDR) + (DDR_NV_SIZE))/*lint -restore */ ) 
#endif 
...
#define DDR_MCORE_SIZE 0x8600000 
#endif 
...
#define DDR_ACORE_DTS_ADDR (/*lint -save -e778 -e835*/((DDR_ACORE_ADDR) + (DDR_ACORE_SIZE))/*lint -restore */ ) 
#endif 
...
#define DDR_MDM_ACP_ADDR (/*lint -save -e778 -e835*/((DDR_ACORE_DTS_ADDR) + (DDR_ACORE_DTS_SIZE))/*lint -restore */ ) 
#endif 
...
#define MODEM_SHARED_DDR_BASE (0xAA000000) 
#endif 

#else
#ifndef MODEM_SHARED_DDR_BASE
#define MODEM_SHARED_DDR_BASE (0x8A000000) 
#endif 
...
#define SHM_SIZE_RESTORE_AXI (HI_SRAM_SIZE) 
#endif 
