...
#define DRIVER_NAME "TIANMA_TD4302"

#define ERROR                          -1
#define G_CABC_MODE1                   1
#define G_DEBUG_ENABLE0                0
#define G_DEBUG_ENABLE1                1
#define STR_BASE                       0
#define GPIO_DELAY                     50
#define LP_DELAY                       12
#define VCC_DELAY                      200
#define BL_FLAG                        2
#define BL_FLAG_NUM1                   1
#define BL_VC                          0
#define BL_WAIT                        100
#define BL_LEVEL_255                   255
#define VALUE_NUM5                     5
#define VALUE_NUM2                     2
#define VALUE_NUM1                     1
#define READ_VALUE_NUM0                0
#define READ_VALUE_NUM1                1
#define READ_VALUE_NUM2                2
#define READ_VALUE_NUM3                3
#define READ_VALUE_NUM4                4
#define REG_VC                         0
#define REG_WAIT                       10
#define REG_WAIT5                      5
#define REG_DLEN2                      0x02
#define REG_PAYLOAD                    NULL
#define LOG_ON                         1
#define LOG_OFF                        0
#define BUG_ON1                        1
#define DISP_NUM1                      1
#define DISP_NUM2                      2
#define RIGHT_SHIFT8                   8
#define DISP_NUM3                      3
#define DISP_NUM4                      4
#define KEEP_BITS                      0xFF
#define SPARE_ONE                      1
#define ACTUAL_ONE                     1
#define G_DEBUG2                       2
#define G_TP0                          0
...
#define PDEV_ID                        1
#define BLPWM_EN                       1
#define ACM_SUPPORT                    1
#define CE_SUPPORT                     1
#define GAMMA_SUPPORT                  1
#define COMFORM_SUPPORT                1
#define CINEMA_SUPPORT                 1
#define HIACE_SUPPORT                  1
#define DIRTY_SUPPORT                  1
#define GMP_LUT0                       0
#define RATE_DIV                       3
#define RATE_DIV_SET                   1
#define G_CE_ON                        1
...
static struct dsi_cmd_desc lcd_display_on_cmd[] = {
	...
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US,
		sizeof(pwm_out), pwm_out},
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US,
		sizeof(led_pwm), led_pwm},
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US,
		sizeof(init_code1), init_code1},
...
static char ce_set_mode_nomal_ca[] = {
	0xca,
	0x1d,0xFC,0xFC,0xFC,0x02,0x1A,0xDB,0xE4,0x00,0xDF,
	0x02,0x08,0x00,0xf2,0x0a,0x14,0xFB,0x13,0xF9,0x02,
	0xF9,0xf5,0xea,0xa8,0x92,0xe8,0xa6,0x8d,0x4d,0x00,
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,
};
static char ce_set_mode_cinema_ca[] = {
	0xca,
	0x1d,0xFc,0xFC,0xFC,0x02,0x05,0xDD,0x1B,0x00,0xDF,
	0x02,0x08,0x00,0xf2,0x0a,0x14,0xFB,0x13,0xF9,0x03,
	0xff,0xb1,0xea,0xa8,0x92,0xe0,0xaa,0x96,0x4d,0x00,
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,
};
static struct dsi_cmd_desc tianma_ce_nomal_cmds[] = {
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(nvm_access_protect_open), nvm_access_protect_open},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(ce_set_mode_nomal_ca), ce_set_mode_nomal_ca},
};
static struct dsi_cmd_desc tianma_ce_cinema_cmds[] = {
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(nvm_access_protect_open), nvm_access_protect_open},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(ce_set_mode_cinema_ca), ce_set_mode_cinema_ca},
};
/*******************************************************************************
** COLOR ENLANCEMENT
...
static struct gpio_desc lcd_gpio_normal_cmds_sub2[] = {
	...
	{DTYPE_GPIO_OUTPUT, WAIT_TYPE_MS, 20,
		GPIO_LCD_RESET_NAME, &gpio_lcd_reset, 0},
	{DTYPE_GPIO_OUTPUT, WAIT_TYPE_MS, 75,
		GPIO_LCD_RESET_NAME, &gpio_lcd_reset, 1},
};
...
#define SENCE_ARRAY_SIZE 3
static char lcd_cmd_now[LCD_CMD_NAME_MAX] = {0};

static char *sence_array[SENCE_ARRAY_SIZE] = {"RUNNINGTEST10","BL_OPEN_SHORT","RUNNINGTEST17",
};

static char *cmd_array[SENCE_ARRAY_SIZE] = {"BL_OPEN_SHORT","/sys/class/lm36923/lm36923/self_test","GPU_TEST",
};
