...
/* #endif  //_PRE_WLAN_FEATURE_ROAM */
    ...
    OAM_FILE_ID_DMAC_CONFIG_DEBUG_C     = 1521,

    OAM_FILE_ID_DMAC_GREEN_AP_C         = 1522,
    OAM_FILE_ID_DMAC_GREEN_AP_H         = 1523,

    OAM_FILE_ID_DMAC_11K_H              = 1524,
    OAM_FILE_ID_DMAC_11K_C              = 1525,

    OAM_FILE_ID_DMAC_AUTO_CALI_C        = 1526,
    OAM_FILE_ID_DMAC_AUTO_CALI_H        = 1527,

#ifdef _PRE_WLAN_FEATURE_WMMAC
    OAM_FILE_ID_HMAC_WMMAC_C            = 1528,
    OAM_FILE_ID_HMAC_WMMAC_H            = 1529,
    OAM_FILE_ID_DMAC_WMMAC_C            = 1530,
    OAM_FILE_ID_DMAC_WMMAC_H            = 1531,
#endif
    ...
    OAM_FILE_ID_HMAC_BTCOEX_C                 = 1658,
#endif
    ...
    OAM_FILE_ID_DMAC_DEVICE_C_ADD           = 2118,
