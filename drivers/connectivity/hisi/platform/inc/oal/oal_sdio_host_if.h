...
extern oal_int32 oal_sdio_wakelock_active(struct oal_sdio *pst_hi_sdio);
...
OAL_STATIC OAL_INLINE oal_int32 oal_sdio_exception_is_busy(struct oal_sdio *hi_sdio)
{
    return OAL_FALSE;
}

OAL_STATIC OAL_INLINE oal_uint32 oal_sdio_dump_mem_check(struct oal_sdio *hi_sdio)
{
    return 0;
}

OAL_STATIC OAL_INLINE oal_int32 oal_trigger_sdio_exception(struct oal_sdio *hi_sdio, oal_int32 is_sync)
{
    return OAL_FALSE;
}

OAL_STATIC OAL_INLINE oal_void oal_sdio_try_to_dump_device_mem(struct oal_sdio *hi_sdio, oal_int32 is_sync)
{
    return;
}
