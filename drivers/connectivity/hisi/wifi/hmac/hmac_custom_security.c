    ...
    *ppst_autoblacklist = OAL_PTR_NULL;
    ...
    if (OAL_PTR_NULL != *ppst_autoblacklist)
    {
        OAM_INFO_LOG4(pst_mac_vap->uc_vap_id, OAM_SF_ANY,
            ...
            ul_blacklist_index,puc_mac_addr[4],puc_mac_addr[5],pst_autoblacklist->ul_asso_counter);/* [false alarm]:pst_autoblacklist不可能为空，如果为空那说明ppst_autoblacklist也为空，那这个分支不可能进入*/
        return OAL_SUCC;
    }
