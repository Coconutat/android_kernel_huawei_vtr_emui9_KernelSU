...
#define WLAN_SERVICE_VAP_MAX_NUM_PER_DEVICE     4   /* 业务VAP个数(原本应该用AP个数+STA个数（这个表示芯片最大支持能力）,软件约束和资源上命令成3即可) */
#else
#define WLAN_SERVICE_VAP_MAX_NUM_PER_DEVICE     3   /* 业务VAP个数(原本应该用AP个数+STA个数（这个表示芯片最大支持能力）,软件约束和资源上命令成3即可) */
#endif
