...
OAL_STATIC OAL_INLINE oal_void oal_queue_set_16(oal_queue_stru_16 *pst_queue, oal_uint *pul_buf, oal_uint16 us_max_elements)
{
    pst_queue->pul_buf         = pul_buf;
...
OAL_STATIC OAL_INLINE oal_uint32  oal_queue_enqueue_16(oal_queue_stru_16 *pst_queue, oal_void *p_element)
{
    ...
    /* 将元素的地址保存在队列中 */
    pst_queue->pul_buf[us_tail_index] = (oal_uint)p_element;
