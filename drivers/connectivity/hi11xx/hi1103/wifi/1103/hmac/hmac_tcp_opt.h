...
oal_uint16 hmac_tcp_opt_rx_tcp_ack_filter_etc(void *hmac_device, hmac_tcp_opt_queue type,hcc_chan_type dir, void* data);
oal_uint16 hmac_tcp_opt_tx_tcp_ack_filter_etc(void *hmac_device, hmac_tcp_opt_queue type,hcc_chan_type dir, void* data);
