...
#ifndef __VDM_HAL_VC1_HEADER__
#define __VDM_HAL_VC1_HEADER__
...
SINT32 VC1HAL_InitHal( UADDR CodeTabAddr );
SINT32 VC1HAL_StartDec(VC1_DEC_PARAM_S  *pVc1DecParam, SINT32 VdhId );
//VOID VC1HAL_DnMsgInit(VC1_DNMSGINF_S *pDnMsgInf);
#ifdef __cplusplus
}
#endif
