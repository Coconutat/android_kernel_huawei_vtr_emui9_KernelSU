...
SINT32 VP8HAL_InitHal(UADDR CodeTabAddr);
SINT32 VP8HAL_CfgReg(VP8_DEC_PARAM_S *pVp8DecParam, VDMHAL_HWMEM_S *pHwMem , SINT32 VdhId);
SINT32 VP8HAL_StartDec(VP8_DEC_PARAM_S *pVp8DecParam, SINT32 VdhId);
SINT32 VP8HAL_CfgDnMsg(VP8_DEC_PARAM_S *pVp8DecParam, VDMHAL_HWMEM_S *pHwMem, SINT32 VdhId);
#ifdef __cplusplus
}
#endif
