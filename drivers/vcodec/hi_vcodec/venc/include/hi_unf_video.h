...
typedef enum hi_UNF_AVC_LEVEL_E
{
    HI_LEVEL_1  = 10,                                //!< H264 Level as specified in the specification
    HI_LEVEL_1B = 1,                                //!< Special-case H264 Level
    HI_LEVEL_11 = 11,                               //!< H264 Level as specified in the specification
    HI_LEVEL_12 = 12,                               //!< H264 Level as specified in the specification
    HI_LEVEL_13 = 13,                               //!< H264 Level as specified in the specification
    HI_LEVEL_2  = 20,                                //!< H264 Level as specified in the specification
    HI_LEVEL_21 = 21,                               //!< H264 Level as specified in the specification
    HI_LEVEL_22 = 22,                               //!< H264 Level as specified in the specification
    HI_LEVEL_3  = 30,                                //!< H264 Level as specified in the specification
    HI_LEVEL_31 = 31,                               //!< H264 Level as specified in the specification
    HI_LEVEL_32 = 32,                               //!< H264 Level as specified in the specification
    HI_LEVEL_4  = 40,                                //!< H264 Level as specified in the specification
    HI_LEVEL_41 = 41,                               //!< H264 Level as specified in the specification
    HI_LEVEL_42 = 42,                               //!< H264 Level as specified in the specification
    HI_LEVEL_5  = 50,                                //!< H264 Level as specified in the specification
    HI_LEVEL_51 = 51,                               //!< H264 Level as specified in the specification
