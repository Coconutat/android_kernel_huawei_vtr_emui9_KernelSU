...
/*regStatus_t byte index*/
#define regStatusIdxx0a    0x6
#define regStatusIdx1a     0x5
#define regInterruptIdxa   0x4
#define regInterruptIdxb   0x3
#define regStatusIdx0      0x2
#define regStatusIdx1      0x1
#define regInterruptIdx    0x0
