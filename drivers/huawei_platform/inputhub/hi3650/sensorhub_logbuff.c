...
#define DDR_SHMEM_MISC_SIZE  (0x3000) /*!!!keep same with sensorhub ddr.h!!!*/
#define LOG_BUFF_SIZE (1024*4)
#define DDR_LOG_BUFF_ADDR (HISI_RESERVED_SENSORHUB_SHARE_MEM_PHYMEM_BASE)
#define DDR_LOG_BUFF_SIZE ((HISI_RESERVED_SENSORHUB_SHARE_MEM_PHYMEM_SIZE - DDR_SHMEM_MISC_SIZE)&~(LOG_BUFF_SIZE-1))
