...
/* Remove SDIO Host Controller communication */
extern int bcmsdh_remove(bcmsdh_info_t *bcmsdh);

/* Suspend SDIO Host Controller communication */
extern int bcmsdh_suspend(bcmsdh_info_t *bcmsdh);

#ifdef HW_SKIP_CMD52_TIMEOUT_LOG
extern int bcmsdh_wakelog_switch(void *sdh, bool enable);
#endif
