...
static const ROUTE_ID_ADDR_STRU npu_routeid_addr_tbl[] = {
	/* Init_flow  Targ_flow  Targ_subrange Init_localAddress */
	/* ----------------------------------------------------- */
	{0x06, 0x00, 0x0, 0xe5000000}, /*noc_aicore_cfg*/
	{0x06, 0x01, 0x0, 0xe4800000}, /*noc_l2buffer_slv0_rd*/
	{0x06, 0x01, 0x1, 0xe4800000}, /*noc_l2buffer_slv0_rd*/
	{0x06, 0x01, 0x2, 0xe4800000}, /*noc_l2buffer_slv0_rd*/
	{0x06, 0x01, 0x3, 0xe4800000}, /*noc_l2buffer_slv0_rd*/
	{0x06, 0x02, 0x0, 0xe4800000}, /*noc_l2buffer_slv0_wr*/
	{0x06, 0x02, 0x1, 0xe4800000}, /*noc_l2buffer_slv0_wr*/
	{0x06, 0x02, 0x2, 0xe4800000}, /*noc_l2buffer_slv0_wr*/
	{0x06, 0x02, 0x3, 0xe4800000}, /*noc_l2buffer_slv0_wr*/
	{0x01, 0x03, 0x0, 0xe4800080}, /*noc_l2buffer_slv1_rd*/
	{0x01, 0x03, 0x1, 0xe4800100}, /*noc_l2buffer_slv1_rd*/
	{0x01, 0x03, 0x2, 0xe4800200}, /*noc_l2buffer_slv1_rd*/
	{0x01, 0x03, 0x3, 0xe4800400}, /*noc_l2buffer_slv1_rd*/
	{0x06, 0x04, 0x0, 0xe4800080}, /*noc_l2buffer_slv1_wr*/
	{0x06, 0x04, 0x1, 0xe4800100}, /*noc_l2buffer_slv1_wr*/
	{0x06, 0x04, 0x2, 0xe4800200}, /*noc_l2buffer_slv1_wr*/
	{0x06, 0x04, 0x3, 0xe4800400}, /*noc_l2buffer_slv1_wr*/
	{0x01, 0x05, 0x0, 0xe0000000}, /*noc_npu2cfgbus*/
	{0x01, 0x06, 0x1, 0xe5e00000}, /*noc_npubus_cfg*/
	{0x00, 0x07, 0x0, 0x0}, /*noc_npubus_ddrc0_rd*/
	{0x00, 0x07, 0x1, 0x0}, /*noc_npubus_ddrc0_rd*/
	{0x00, 0x07, 0x2, 0x0}, /*noc_npubus_ddrc0_rd*/
	{0x00, 0x07, 0x3, 0x0}, /*noc_npubus_ddrc0_rd*/
	{0x00, 0x07, 0x4, 0x0}, /*noc_npubus_ddrc0_rd*/
	{0x00, 0x07, 0x5, 0x0}, /*noc_npubus_ddrc0_rd*/
	{0x00, 0x07, 0x6, 0x0}, /*noc_npubus_ddrc0_rd*/
	{0x00, 0x07, 0x7, 0x0}, /*noc_npubus_ddrc0_rd*/
	{0x01, 0x08, 0x0, 0x0}, /*noc_npubus_ddrc0_wr*/
	{0x01, 0x08, 0x1, 0x0}, /*noc_npubus_ddrc0_wr*/
	{0x01, 0x08, 0x2, 0x0}, /*noc_npubus_ddrc0_wr*/
	{0x01, 0x08, 0x3, 0x0}, /*noc_npubus_ddrc0_wr*/
	{0x01, 0x08, 0x4, 0x0}, /*noc_npubus_ddrc0_wr*/
	{0x01, 0x08, 0x5, 0x0}, /*noc_npubus_ddrc0_wr*/
	{0x01, 0x08, 0x6, 0x0}, /*noc_npubus_ddrc0_wr*/
	{0x01, 0x08, 0x7, 0x0}, /*noc_npubus_ddrc0_wr*/
	{0x00, 0x09, 0x0, 0x80}, /*noc_npubus_ddrc1_rd*/
	{0x00, 0x09, 0x1, 0x100},/*noc_npubus_ddrc1_rd*/
	{0x00, 0x09, 0x2, 0x200},/*noc_npubus_ddrc1_rd*/
	{0x00, 0x09, 0x3, 0x400},/*noc_npubus_ddrc1_rd*/	
	{0x01, 0x0A, 0x0, 0x80},  /*noc_npubus_ddrc1_wr*/
	{0x01, 0x0A, 0x1, 0x100}, /*noc_npubus_ddrc1_wr*/
	{0x01, 0x0A, 0x2, 0x200}, /*noc_npubus_ddrc1_wr*/
	{0x01, 0x0A, 0x3, 0x400}, /*noc_npubus_ddrc1_wr*/
	{0x01, 0x0B, 0x0, 0xe4000000}, /*noc_npucpu_cfg*/
	{0x06, 0x0C, 0x0, 0xe5c00000}, /*noc_npugic_cfg*/
	{0x08, 0x0D, 0x0, 0xe4d30000}, /*npubus_service_target*/
	{0x08, 0x0D, 0x1, 0x0}, /*npubus_service_target*/
	{0x08, 0x0D, 0x2, 0x0}, /*npubus_service_target*/
	{0x08, 0x0D, 0x3, 0x0}, /*npubus_service_target*/
	{0x08, 0x0D, 0x4, 0x0}, /*npubus_service_target*/
	{0x08, 0x0D, 0x5, 0x0}, /*npubus_service_target*/
	{0x08, 0x0D, 0x6, 0x0}, /*npubus_service_target*/
	{0x08, 0x0D, 0x7, 0x0}, /*npubus_service_target*/
	{0x08, 0x0D, 0x8, 0x0}, /*npubus_service_target*/
};

/*
里面的bus id就是当前有独立的3条bus，现在增加到4条，包括NPU
*/


struct noc_mid_info noc_mid_PHOE[] = {
...
struct noc_sec_info noc_sec_PHOE[] = {
...
struct noc_dump_reg noc_dump_reg_list_PHOE[] = {
 ...
 */
const struct noc_busid_initflow hisi_filter_initflow_PHOE[] = {
...
const struct noc_bus_info noc_buses_info_PHOE[] = {
	[0] = {
		...
		.p_noc_mid_info = noc_mid_PHOE,
		.noc_mid_info_size = ARRAY_SIZE_NOC(noc_mid_PHOE),
		.p_noc_sec_info = noc_sec_PHOE,
		.noc_sec_info_size = ARRAY_SIZE_NOC(noc_sec_PHOE),
	},
	[1] = {
		.name = "vcodec_bus",
 ...
 */
void hisi_noc_get_array_size_PHOE(unsigned int *bus_info_size, unsigned int *dump_list_size)
{
	if ((NULL == bus_info_size)||(NULL == dump_list_size))
		return;

	*bus_info_size  = ARRAY_SIZE_NOC(noc_buses_info_PHOE);
	*dump_list_size = ARRAY_SIZE_NOC(noc_dump_reg_list_PHOE);
}
 ...
 */
unsigned int hisi_noc_clock_enable_PHOE(struct hisi_noc_device *noc_dev,
