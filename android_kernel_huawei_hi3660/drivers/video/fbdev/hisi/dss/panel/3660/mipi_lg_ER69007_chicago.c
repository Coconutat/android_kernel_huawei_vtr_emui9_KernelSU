...
//static char panel_on_cmd3 [] ={0xB6,0x3B,0x93,0x00};//only for fpga setting phyclk
//display set 1
static char panel_on_cmd4 [] ={
0xC1,0x80,0x08,0x11,0xFF,0xFD,0xF8,0xE5,0x9F,0x9F,0x9A,0xB3,0xFE,
0xFF,0x17,0xFF,0xFF,0xD7,0x31,0xE5,0x93,0x3F,0xBE,0xF8,0xE0,0x03,
...
static char panel_on_cmd18[] ={0xD5,0x66,0x00,0x00,0x01,0x34,0x01,0x34,0x00,0x2F,0x00,0x2F};
...
//	{DTYPE_GEN_LWRITE, 0,100, WAIT_TYPE_US,sizeof(panel_on_cmd3 ),panel_on_cmd3},//only for fpga setting phyclk
...
static u32 cinema_gamma_lut_table_R[] = {
	...
	0x0036, 0x0037, 0x0038, 0x0039, 0x003a, 0x003c, 0x003d, 0x003e, 0x003f, 0x0040, 0x0041, 0x0042, 0x0043, 0x0044, 0x0045, 0x0046,
	0x0047, 0x0049, 0x004a, 0x004b, 0x004d, 0x004e, 0x004f, 0x0051, 0x0052, 0x0053, 0x0054, 0x0056, 0x0057, 0x0058, 0x0059, 0x005a,
	0x005c, 0x005d, 0x005e, 0x005f, 0x0060, 0x0061, 0x0062, 0x0063, 0x0064, 0x0065, 0x0066, 0x0067, 0x0068, 0x0069, 0x006a, 0x006c,
	0x006d, 0x006e, 0x006f, 0x0071, 0x0072, 0x0073, 0x0074, 0x0076, 0x0077, 0x0078, 0x0079, 0x007a, 0x007a, 0x007c, 0x007e, 0x0080,
	0x0081, 0x0083, 0x0084, 0x0085, 0x0086, 0x0087, 0x0089, 0x008a, 0x008c, 0x008d, 0x008e, 0x008f, 0x0090, 0x0092, 0x0093, 0x0094,
	0x0096, 0x0097, 0x0099, 0x009a, 0x009b, 0x009d, 0x009e, 0x009f, 0x00a0, 0x00a1, 0x00a2, 0x00a4, 0x00a5, 0x00a6, 0x00a7, 0x00a8,
	0x00a9, 0x00ab, 0x00ac, 0x00ad, 0x00ae, 0x00af, 0x00b1, 0x00b2, 0x00b3, 0x00b4, 0x00b5, 0x00b6, 0x00b7, 0x00b8, 0x00b9, 0x00ba,
	...
	0x00eb, 0x00ec, 0x00ed, 0x00ee, 0x00ef, 0x00f0, 0x00f1, 0x00f2, 0x00f3, 0x00f4, 0x00f5, 0x00f6, 0x00f7, 0x00f7, 0x00f8, 0x00f8,
	0x00f9, 0x00f9, 0x00f9, 0x00f9, 0x00f9, 0x00f9, 0x00fa, 0x00fa, 0x00fb, 0x00fb, 0x00fc, 0x00fc, 0x00fd, 0x00fd, 0x00fe, 0x00ff,
};
	...
	char *buf)
{
	...
	ret = snprintf(buf, PAGE_SIZE, "LG_eR69007 6' CMD TFT Chicago\n");
...
static int mipi_lg_probe(struct platform_device *pdev)
{
	...
	if (g_lcd_fpga_flag == 1) {
		...
		if (is_mipi_cmd_panel_ext(pinfo)) {
			//63fps
			pinfo->ldi.h_back_porch = 96;//23;
			pinfo->ldi.h_front_porch = 108;//50
			pinfo->ldi.h_pulse_width = 48;//20
			pinfo->ldi.v_back_porch = 56;//28
			pinfo->ldi.v_front_porch = 28;//14
		...
		pinfo->pxl_clk_rate = 267 * 1000000UL;
		//mipi
