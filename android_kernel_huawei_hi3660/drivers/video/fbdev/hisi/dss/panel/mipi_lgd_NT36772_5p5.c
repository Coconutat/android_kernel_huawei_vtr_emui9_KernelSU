...
static uint32_t expected_checksum[CHECKSUM_PIC_N][CHECKSUM_SIZE] = {
	{0x5, 0x76, 0xbb, 0xda, 0xf0, 0x5b, 0xca, 0xf2}, //runningtest1
	{0xc9, 0x99, 0x48, 0x21, 0xc3, 0xbe, 0x59, 0x7d}, //runningtest2
	{0xb8, 0x4e, 0x9, 0x46, 0x4c, 0x1f, 0xe6, 0x98}, //runningtest3
};
...
static int mipi_lg_panel_lcd_lv_detect(struct platform_device *pdev)
{
	...
	mipi_dsi_cmds_rx(&rd, lcd_lv_detect_reg, \
...
#define	NT36772_EBABLE_CHECKSUM	1
#define	NT36772_DISABLE_CHECKSUM 0
#define	NT36772_TEST_PIC_0	3
#define	NT36772_TEST_PIC_1	4
#define	NT36772_TEST_PIC_2	5
#define	NT36772_PIC0_NUM	0
#define	NT36772_PIC1_NUM	1
#define	NT36772_PIC2_NUM	2
static ssize_t mipi_lg_panel_lcd_gram_check_show(struct platform_device *pdev, char *buf)
{
	...
	int i = 0;
	char cmdF_page0_select[] = {0xFF, 0x25};
	char crc_page0_select[] = {0x93, 0x14};
	char checksum_read[] = {0x99};
	//0:success; 1:fail
	int checksum_result = 1;
	struct dsi_cmd_desc packet_size_set_cmd = {DTYPE_MAX_PKTSIZE, 0, 10, WAIT_TYPE_US, 1, NULL};
	struct dsi_cmd_desc lcd_checksum_select_cmds[] = {
		{DTYPE_DCS_WRITE1, 0, 50, WAIT_TYPE_MS,
			sizeof(cmdF_page0_select), cmdF_page0_select},
	};
	struct dsi_cmd_desc lcd_checksum_page0_select_cmds[] = {
		{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_MS,
			sizeof(crc_page0_select), crc_page0_select},
	};
	...
	switch (checksum_pic_n){
		case NT36772_PIC0_NUM:
		case NT36772_PIC1_NUM:
		case NT36772_PIC2_NUM:
	...
	mipi_dsi_cmds_tx(lcd_checksum_page0_select_cmds, \
		ARRAY_SIZE(lcd_checksum_page0_select_cmds), mipi_dsi0_base);
	...
	const char *buf, size_t count)
{
	...
	char cmd2_page5_select[] = {0xFF, 0x25};
	char cmd2_page5_noload[] = {0xFB, 0x01};
	char checksum_ena1[] = {0x91, 0x03};
	char checksum_ena2[] = {0x92, 0x1f};
	char checksum_ena3[] = {0x93, 0x04};
	char checksum_en4[] = {0xb0, 0x01};
	char checksum_setting1[] = {0x94, 0xA0};
	char checksum_setting2[] = {0x95, 0x02};
	char checksum_setting3[] = {0x96, 0x01};
	char checksum_setting4[] = {0x97, 0x00};
	char checksum_setting5[] = {0x98, 0x00};
	/* gram checksum disable */
	char checksum_dis3[] = {0x93, 0x00};
	...
	struct dsi_cmd_desc lcd_checksum_enable_cmds[] = {
		{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US,
			sizeof(cmd2_page5_select), cmd2_page5_select},
		{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US,
			sizeof(cmd2_page5_noload), cmd2_page5_noload},
		{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US,
			sizeof(checksum_ena1), checksum_ena1},
		{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US,
			sizeof(checksum_ena2), checksum_ena2},
		{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US,
			sizeof(checksum_setting1), checksum_setting1},
		{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US,
			sizeof(checksum_setting2), checksum_setting2},
		{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US,
			sizeof(checksum_setting3), checksum_setting3},
		{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US,
			sizeof(checksum_setting4), checksum_setting4},
		{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US,
			sizeof(checksum_setting5), checksum_setting5},
		{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US,
			sizeof(cmd1_page0_select), cmd1_page0_select},

		{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US,
			sizeof(checksum_en4), checksum_en4},
		/* display on*/
		{DTYPE_DCS_WRITE, 0, 120, WAIT_TYPE_MS,
			sizeof(exit_sleep), exit_sleep},
		{DTYPE_DCS_WRITE, 0, 120, WAIT_TYPE_MS,
		...
		{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US,
			sizeof(cmd2_page5_noload), cmd2_page5_noload},
		{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US,
			sizeof(checksum_ena3), checksum_ena3},
	};
	...
	struct dsi_cmd_desc lcd_checksum_disable_cmds[] = {
		...
		{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US,
			sizeof(cmd2_page5_noload), cmd2_page5_noload},
		{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US,
			sizeof(checksum_dis3), checksum_dis3},
		{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US,
			sizeof(cmd1_page0_select), cmd1_page0_select},
	};
	...
	switch(val){
		...
		case NT36772_EBABLE_CHECKSUM:
			...
			break;
		case NT36772_TEST_PIC_0:
		case NT36772_TEST_PIC_1:
		case NT36772_TEST_PIC_2:
