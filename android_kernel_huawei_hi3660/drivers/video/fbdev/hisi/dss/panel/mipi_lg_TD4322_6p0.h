...
static struct dsi_cmd_desc lg_display_bist_check_cmds1[] = {
...
static struct dsi_cmd_desc lg_display_bist_check_cmds2[] = {
	{DTYPE_DCS_WRITE1, 0, 200, WAIT_TYPE_MS,
...
static struct dsi_cmd_desc lg_display_bist_check_cmds3[] = {
...
static struct dsi_cmd_desc lg_display_bist_check_cmds4[] = {
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US,
...
static struct dsi_cmd_desc lg_display_bist_check_cmds5[] = {
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US,
...
static struct dsi_cmd_desc lg_display_bist_check_cmds6[] = {
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US,
...
static struct dsi_cmd_desc lg_display_bist_check_cmds7[] = {
...
static struct dsi_cmd_desc lg_display_bist_check_cmds8[] = {
...
static struct dsi_cmd_desc lg_display_bist_check_end[] = {
	{DTYPE_DCS_WRITE1, 0, 200, WAIT_TYPE_MS,
...
static char ce_off[] = {
	0xCA,
	0x1D,0xFC,0xFC,0xFC,0x0,0x0D,0x02,0xF0,0x0,0xF5,
	0xDB,0x01, 0x0F, 0x19, 0xF0,0x0D,0xE9,0x0,0x0,0x08,
	0x0, 0x0, 0xEA, 0xA8, 0x92,0xEC,0xB0,0x9F,0x58,0x0,
	0xFF, 0x0, 0x4E, 0xFC, 0x04,0xE9,0x0,0x0,0xFF,0x3E,
	0x0,0xFF, 0xFF,
};
...
static char ce_set_mode_USER[] = {
	...
	0xE8, 0xC7, 0xEA, 0xA8, 0x92,0xE8,0xA9,0x9C,0x40,0x1D,
...
static struct dsi_cmd_desc lg_ce_off_cmds[] = {
	{DTYPE_DCS_LWRITE, 0, 10, WAIT_TYPE_US,
		 sizeof(ce_off), ce_off},
};

static struct dsi_cmd_desc lg_ce_srgb_cmds[] = {
	{DTYPE_DCS_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(ce_set_mode_SRGB), ce_set_mode_SRGB},
};

static struct dsi_cmd_desc lg_ce_user_cmds[] = {
	{DTYPE_DCS_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(ce_set_mode_USER), ce_set_mode_USER},
};

static struct dsi_cmd_desc lg_ce_vivid_cmds[] = {
	{DTYPE_DCS_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(ce_set_mode_VIVID), ce_set_mode_VIVID},
};

static char digtal_gamma_setting[] = {
	0xC8,
	0x01,
};
...
** MIPI ARRAY
*/
static struct dsi_cmd_desc lg_display_effect_on_cmds[] = {
...
static struct dsi_cmd_desc* lg_display_bist_check_cmds[] = {
	lg_display_bist_check_cmds1,
	lg_display_bist_check_cmds2,
	lg_display_bist_check_cmds3,
	lg_display_bist_check_cmds4,
	lg_display_bist_check_cmds5,
	lg_display_bist_check_cmds6,
	lg_display_bist_check_cmds7,
	lg_display_bist_check_cmds8,
};

static int bist_check_cmds_size[] = {
	ARRAY_SIZE(lg_display_bist_check_cmds1),
	ARRAY_SIZE(lg_display_bist_check_cmds2),
	ARRAY_SIZE(lg_display_bist_check_cmds3),
	ARRAY_SIZE(lg_display_bist_check_cmds4),
	ARRAY_SIZE(lg_display_bist_check_cmds5),
	ARRAY_SIZE(lg_display_bist_check_cmds6),
	ARRAY_SIZE(lg_display_bist_check_cmds7),
