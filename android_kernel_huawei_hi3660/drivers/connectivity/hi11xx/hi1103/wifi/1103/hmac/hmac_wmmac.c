                ...
                oal_uint8                  *puc_payload)
{
    ...
    {
        OAM_ERROR_LOG3(0, OAM_SF_WMMAC, "{hmac_mgmt_rx_addts_rsp_etc::null param, %p %p %p.}", pst_hmac_vap, pst_hmac_user, puc_payload);
        return OAL_ERR_CODE_PTR_NULL;
    }
                ...
                oal_uint8                  *puc_payload)
{
    ...
    if ((OAL_PTR_NULL == pst_hmac_vap) || (OAL_PTR_NULL == pst_hmac_user) || (OAL_PTR_NULL == puc_payload))
    {
        OAM_ERROR_LOG3(0, OAM_SF_WMMAC, "{hmac_mgmt_rx_delts_etc::null param, %p %p %p.}", pst_hmac_vap, pst_hmac_user, puc_payload);
        return OAL_ERR_CODE_PTR_NULL;
    }
...
oal_uint32  hmac_tx_mgmt_reassoc_req_etc(hmac_vap_stru *pst_hmac_vap_sta)
{
    ...
    {
        OAM_ERROR_LOG1(0, OAM_SF_ASSOC, "{hmac_tx_mgmt_reassoc_req_etc,%p.}", pst_hmac_vap_sta);
        return OAL_ERR_CODE_PTR_NULL;
    }
