...
dmac-objs := $(DMAC_SCRDIR)\dmac_main.o $(DMAC_SCRDIR)\dmac_mgmt_classifier.o $(DMAC_SCRDIR)\dmac_psm_ap.o $(DMAC_SCRDIR)\dmac_rx_data.o $(DMAC_SCRDIR)\dmac_tid.o $(DMAC_SCRDIR)\dmac_tx_bss_comm.o				\
			 ...
			 $(DMAC_SCRDIR)\dmac_blockack.o $(DMAC_SCRDIR)\mac_resource.o $(DMAC_SCRDIR)\dmac_mgmt_ap.o $(DMAC_SCRDIR)\dmac_mgmt_sta.o $(DMAC_SCRDIR)\dmac_wep.o $(DMAC_SCRDIR)\dmac_11i.o	$(DMAC_SCRDIR)\dmac_11k.o	\
			 $(DMAC_SCRDIR)\mac_regdomain.o $(DMAC_SCRDIR)\dmac_scan.o $(DMAC_SCRDIR)\dmac_dfx.o $(DMAC_SCRDIR)\dmac_reset.o $(DMAC_SCRDIR)\dmac_config.o $(DMAC_SCRDIR)\dmac_config_debug.o $(DMAC_SCRDIR)\dmac_stat.o $(DMAC_SCRDIR)\dmac_fcs.o \
...
dmac-objs += $(DMAC_SCRDIR)\dmac_btcoex.o $(DMAC_SCRDIR)\dmac_ltecoex_verify.o $(DMAC_SCRDIR)\dmac_arp_offload.o $(DMAC_SCRDIR)\dmac_auto_adjust_freq.o $(DMAC_SCRDIR)\dmac_wmmac.o
