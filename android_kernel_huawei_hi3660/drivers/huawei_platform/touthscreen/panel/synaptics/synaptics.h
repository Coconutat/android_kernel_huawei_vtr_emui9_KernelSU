...
extern int synaptics_get_fw_data_s3718_boot(char *file_name,
					    struct touch_settings
					    *synaptics_sett_param_regs);
...
extern int synaptics_rmi4_f54_s3207_init(struct synaptics_rmi4_data *rmi4_data,
					 const char *module_name);
extern int synaptics_rmi4_f54_init(struct synaptics_rmi4_data *rmi4_data,
				   const char *module_name);
extern unsigned short synaptics_f54_get_calibrate_addr(struct
						       synaptics_rmi4_data
						       *rmi4_data,
						       const char *module_name);
#ifdef RED_REMOTE
...
extern int synaptics_get_calib_data(struct ts_calibration_data_info *info);
extern int synaptics_get_calib_info(struct ts_calibration_info_param *info);
