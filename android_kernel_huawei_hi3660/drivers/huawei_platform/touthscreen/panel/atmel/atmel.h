...
extern int __mxt_write_reg(struct mxt_data *data, u16 reg, u16 len,
			   const void *val);
...
extern int mxt_t6_command(struct mxt_data *data, u16 cmd_offset, u8 value,
			  bool wait);
extern int mxt_probe_info_block(struct mxt_data *data);
extern int mxt_bootloader_read(struct mxt_data *data, u8 *val,
			       unsigned int count);
extern int mxt_bootloader_write(struct mxt_data *data, const u8 * const val,
				unsigned int count);
...
extern int get_deltas_data_test(struct mxt_data *data, int data_uplimit,
				int data_lowlimit);
extern int get_refs_data_test(struct mxt_data *data, int data_uplimit,
			      int data_lowlimit);
extern int get_refs_rx2rx_delta_test(struct mxt_data *data, int data_uplimit,
				     int data_lowlimit);
extern int get_refs_tx2tx_delta_test(struct mxt_data *data, int data_uplimit,
				     int data_lowlimit);
...
extern int mxt_t25_selftest(struct mxt_data *data, int cmd);
extern int mxt_diagnostic_command(struct mxt_data *data, u8 cmd, u8 page,
				  u8 index, u8 num, char *buf, int interval,
				  int interval_c);
extern int get_refs_or_deltas_data_test(struct mxt_data *data, int data_uplimit,
					int data_lowlimit);
extern int get_enhance_refs_or_deltas_data_test(struct mxt_data *data);
extern int get_enhance_refs_tx2tx_delta_test(struct mxt_data *data);
extern int get_enhance_refs_rx2rx_delta_test(struct mxt_data *data);
extern int get_self_cap_data_test(struct mxt_data *data);
