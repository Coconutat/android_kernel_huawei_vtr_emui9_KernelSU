...
#define TUNER_IOCTL_ENABLEPOWER    _IO(TUNER_IOC_MAGIC,  21)
#define TUNER_IOCTL_DISABLEPOWER    _IO(TUNER_IOC_MAGIC,  22)
...
struct _tuner_data_tsif {
	...
	uint8_t spi_calibration_flag;	//1: calibration execute when tuner_drv_hw_tsif_get_pkts called.
	                                //0: calibration off.
};
