...
static struct sensor_power_setting imx219_duke_power_setting[] = {
...
static sensor_t s_imx219_duke =
{
    .intf = { .vtbl = &s_imx219_vtbl, },
    .power_setting_array = {
            .size = ARRAY_SIZE(imx219_duke_power_setting),
            .power_setting = imx219_duke_power_setting,
     },
};
...
{
    {
        .compatible = "huawei,imx219_duke",
        .data = &s_imx219_duke.intf,
    },
    {
...
static int imx219_config(hwsensor_intf_t* si, void  *argp)
{
    ...
    cam_debug("imx219 duke cfgtype = %d",data->cfgtype);
    switch(data->cfgtype) {
