...
static struct sensor_power_setting hi843_stf_power_setting[] = {
    //SCAM AVDD 2.80V
    {
...
static sensor_t s_hi843_stf =
{
    .intf = { .vtbl = &s_hi843_vtbl, },
    .power_setting_array = {
            .size = ARRAY_SIZE(hi843_stf_power_setting),
            .power_setting = hi843_stf_power_setting,
     },
};
...
{
    {
        .compatible = "huawei,hi843_stf",
        .data = &s_hi843_stf.intf,
    },
    {
...
static int hi843_config(hwsensor_intf_t* si, void  *argp)
{
    ...
    cam_debug("hi843_stf cfgtype = %d",data->cfgtype);
    switch(data->cfgtype) {
...
static int __init hi843_stf_init_module(void)
{
...
static void __exit hi843_stf_exit_module(void)
{
    if (NULL != s_intf) {
...
module_init(hi843_stf_init_module);
module_exit(hi843_stf_exit_module);
MODULE_DESCRIPTION("hi843_stf");
