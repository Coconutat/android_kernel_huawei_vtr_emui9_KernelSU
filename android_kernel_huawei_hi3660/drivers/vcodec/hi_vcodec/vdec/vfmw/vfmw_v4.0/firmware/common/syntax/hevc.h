...
#define HEVC_MAX_TEMPLAYER             (6)             //max number of temporal layer
#else
...
{      
    UINT8   non_existing;              // 0: real frame, 1: fake frame from created lost ref pic
