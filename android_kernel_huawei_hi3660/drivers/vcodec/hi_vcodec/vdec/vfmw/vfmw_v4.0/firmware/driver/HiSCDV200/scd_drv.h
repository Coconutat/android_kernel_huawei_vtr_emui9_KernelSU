...
/************************************************************************
原型  SINT8 SM_IsScdBypassStandard(SINT32 SmID)
功能  判断指定SCD通道是否不需要启动SCD硬件工作的
参数  SmID  码流管理模块的实例的标识
返回值  1 不需要启动SCD，即bypass模式，0 需要启动SCD
************************************************************************/
...
/************************************************************************
原型   SINT32 SCDDRV_IsScdIdle(VOID)
功能   check SCD status
参数
返回值 VFMW_TRUE->0 :IDLE
