...
enum hw_device_type {
    ...
    DEV_CONNECTIVITY_WIFI = DEV_CONNECTIVITY_START, /* 40 */
    DEV_CONNECTIVITY_BT,                            /* 41 */
    DEV_CONNECTIVITY_FM,                            /* 42 */
    DEV_CONNECTIVITY_GPS,                           /* 43 */
    DEV_CONNECTIVITY_GPU,                           /* 44 */
    DEV_CONNECTIVITY_MAX,                           /* 45 */
};
